...
const Mensa = () => {
  const { data, error, loading, createItem, deleteItem, updateItem } =
    useCRUD<Mensa>("/canteen/");
          ...
          {loading ? (
            ...
            <>
              ...
              <View style={styles.containerTotalSearchCanteen}>
                <Text>
                  <Text style={{ color: "#005dff", fontWeight: "bold" }}>
                ...
                {searchResults.map((mensa, index) => (
                  <View key={index} style={styles.mensaItem}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        navigateToPasti(mensa.id.toString(), mensa.name)
                      }
                    >
                      <Text style={styles.buttonText}>
                        <Icon name="arrow-right" size={20} color="wihte" />
                      </Text>
                    </TouchableOpacity>
                  </View>
                ))}
